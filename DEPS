...
gclient_gn_args_file = 'v8-hello-world/build/config/gclient_args.gni'
gclient_gn_args = [
...
deps = {
  'v8-hello-world/base/trace_event/common': Var('trace_common_url') + '@' + Var('trace_common_revision'),
  'v8-hello-world/build': Var('build_url') + '@' + Var('build_revision'),
  'v8-hello-world/buildtools': Var('buildtools_url') + '@' + Var('buildtools_revision'),
  'v8-hello-world/buildtools/clang_format/script': Var('buildtools_clang_format_url') + '@' + Var('buildtools_clang_format_revision'),
  'v8-hello-world/buildtools/third_party/libc++/trunk': Var('buildtools_libcxx_url') + '@' + Var('buildtools_libcxx_revision'),
  'v8-hello-world/buildtools/third_party/libc++abi/trunk': Var('buildtools_libcxxabi_url') + '@' + Var('buildtools_libcxxabi_revision'),
  'v8-hello-world/buildtools/third_party/libunwind/trunk': Var('buildtools_libunwind_url') + '@' + Var('buildtools_libunwind_revision'),
  'v8-hello-world/node': Var('node_url') + '@' + Var('node_revision'),
  'v8-hello-world/third_party/abseil-cpp': Var('abseil_cpp_url') + '@' + Var('abseil_cpp_revision'),
  'v8-hello-world/third_party/depot_tools': Var('depot_tools_url') + '@' + Var('depot_tools_revision'),
  'v8-hello-world/third_party/fuchsia-sdk': {
    'url': Var('fuchsia_sdk_url') + '@' + Var('fuchsia_sdk_revision'),
    'condition': 'checkout_fuchsia',
  },
  'v8-hello-world/third_party/googletest/src': Var('googletest_url') + '@' + Var('googletest_revision'),
  'v8-hello-world/third_party/icu': Var('icu_url') + '@' + Var('icu_revision'),
  'v8-hello-world/third_party/jinja2': Var('jinja2_url') + '@' + Var('jinja2_revision'),
  'v8-hello-world/third_party/markupsafe': Var('markupsafe_url') + '@' + Var('markupsafe_revision'),
  'v8-hello-world/third_party/zlib': Var('zlib_url') + '@' + Var('zlib_revision'),
  'v8-hello-world/tools/clang': Var('clang_url') + '@' + Var('clang_revision'),
  'v8-hello-world/v8': Var('v8_url') + '@' +  Var('v8_revision'),
  'v8-hello-world/buildtools/linux64': {
    'packages': [
      {
...
hooks = [
  {
    ...
    'action': ['python', 'v8-hello-world/build/vs_toolchain.py', 'update'],
  },
  {
    ...
    'action': ['python', 'v8-hello-world/build/mac_toolchain.py'],
  },
  {
    'name': 'clang',
    'pattern': '.',
    'action': ['python', 'v8-hello-world/tools/clang/scripts/update.py'],
  },
  {
    # Update LASTCHANGE.
    'name': 'lastchange',
    'pattern': '.',
    'action': ['python', 'v8-hello-world/build/util/lastchange.py',
               '-o', 'v8-hello-world/build/util/LASTCHANGE'],
  },
  {
    'name': 'sysroot_x64',
    'pattern': '.',
    ...
    'action': ['python',
               'v8-hello-world/build/linux/sysroot_scripts/install-sysroot.py',
               '--arch=x64'],
  },
]